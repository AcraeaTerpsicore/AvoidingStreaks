...
- Exercised the Monte Carlo utilities with deterministic seeds, verifying the returned sample lists (with and without retention) for both strict and soft streak simulations.
